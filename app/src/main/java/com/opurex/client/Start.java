...
import com.opurex.client.sync.SendProcess;
import com.opurex.client.sync.SyncSend;
import com.opurex.client.sync.SyncUpdate;
import com.opurex.client.sync.UpdateProcess;
...
import com.opurex.client.widgets.UserBtnItem;
import com.opurex.client.widgets.UsersBtnAdapter;
...
public class Start extends TrackedActivity implements Handler.Callback {
    ...
    private static final int MENU_Z_ID = 5;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem pastZ = menu.add(Menu.NONE, MENU_Z_ID, 3,
                this.getString(R.string.menu_past_z));
        pastZ.setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);

        MenuItem disconnect = menu.add(Menu.NONE, MENU_DISCONNECT_ID, 4,
                this.getString(R.string.menu_disconnect));
        disconnect.setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);

        MenuItem about = menu.add(Menu.NONE, MENU_ABOUT_ID, 5,
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.getItem(3).setEnabled(CashArchive.hasArchives(this));
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_SYNC_SND_ID:
                ...
                break;
            case MENU_Z_ID:
                Intent i = new Intent(this, ZSelect.class);
                this.startActivity(i);
                break;
            case MENU_ABOUT_ID:
                // About
