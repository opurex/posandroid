 ...
 */
public abstract class OpurexPopupFragment extends DialogFragment {
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        positiveTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                OpurexPopupFragment.this.onPositiveClickListener();
            }
        });
        ...
        negativeTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpurexPopupFragment.this.onNegativeClickListener();
            }
        });
