...
public class BiometricSetupActivity extends POSConnectedTrackedActivity {
        ...
        biometricManager.authenticateForManagerFunctions(new BiometricAuthManager.AuthenticationCallback() {
            ...
            public void onAuthenticationSucceeded() {
                Toast.makeText(BiometricSetupActivity.this,
                        getString(R.string.biometric_test_success), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAuthenticationFailed() {
                Toast.makeText(BiometricSetupActivity.this,
                        getString(R.string.biometric_test_failed), Toast.LENGTH_SHORT).show();
            }
    ...
    public void onDeviceManagerEvent(POSDeviceManager manager, DeviceManagerEvent event) {
        // No device event handling needed here
    }
}
