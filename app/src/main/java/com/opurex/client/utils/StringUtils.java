...
public class StringUtils {
    ...
    public static String formatDateTimeNumeric(Context ctx, long mils) {
        final int flags = DateUtils.FORMAT_SHOW_YEAR | DateUtils.FORMAT_NUMERIC_DATE;
        String dateString = DateUtils.formatDateTime(ctx, mils, flags);
        String[] dateSplit = dateString.split("/");
        int length = dateSplit.length;
        ...
        String date = TextUtils.join("/", dateSplit);
        final int timeFlags = DateUtils.FORMAT_SHOW_TIME;
        String timeString = DateUtils.formatDateTime(ctx, mils, timeFlags);
        return date + " " + timeString;
    }

    public static String formatTimeNumeric(long mils) {
